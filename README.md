...
**Collectionerus Scraper** — инструмент для автоматического скачивания публичных коллекций предметов (открытки, значки, марки, монеты и т.д.) с сайта collectionerus. Проект состоит из трёх основных компонентов:
...
4. **Tests** — прострое тестирование функций.
...
Проект распространяется под лицензией **MIT** — используйте как угодно,
